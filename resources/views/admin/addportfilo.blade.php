                                    ...
                                    <tbody>
                                        @foreach ($newpaper as $key => $item)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $item['name'] }}</td>
                                                <td><img src="{{ asset($item->img) }}" target="_blank" width="150"
                                                        height="80"></img></td>
                                                <td>
                                                    <div class="row">
                                                        {{-- <div class="col-lg-6">
                                                            <a id="{{ $item->id }}" onclick="editportfilo(this.id)"><i style="font-size:20px;  color: rgb(89, 0, 255);" class="fas fa-edit"></i></a>
                                                        </div> --}}

                                                        <div class="col-lg-6">
                                                            <a href="#"
                                                                onclick="deleteportfiloModel('{{ $item->id }}')"><i
