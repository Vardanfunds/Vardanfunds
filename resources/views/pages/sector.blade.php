    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            ...
            <div class="wow fadeInRight row align-items-center page-section" data-wow-delay="0.3s">
                ...
                <div class="col-lg-5">
                    <img class="img-fluid mx-auto d-block custom-img" src="{{ asset('assets/img/ManufacturingSector.png') }}" alt="Image">
                </div>
            ...
            <div class="wow fadeInRight row align-items-center py-6 page-section" data-wow-delay="0.3s">
                ...
                <div class="col-lg-5">
                    <img class="img-fluid mx-auto d-block custom-img" src="{{ asset('assets/img/ConsumptionDriven.jpg') }}" alt="ConsumptionDriven">
                </div>
            ...
            <h5 class="text-primary">Banking & Financial Services</h5>
                ...
                <div class="col-lg-5">
                    <img class="img-fluid mx-auto d-block custom-img" src="{{ asset('assets/img/Banking-FinancialServices.jpg') }}" alt="Banking-FinancialServices">
                </div>
            ...
            <div class="wow fadeInRight row align-items-center page-section" data-wow-delay="0.3s">
                ...
                <div class="col-lg-5">
                    <img class="img-fluid mx-auto d-block custom-img" src="{{ asset('assets/img/Education.jpg') }}" alt="Education">
                </div>
            ...
            <div class="wow fadeInRight row align-items-center page-section" data-wow-delay="0.3s">
                ...
                <div class="col-lg-5">
                    <img class="img-fluid mx-auto d-block custom-img" src="{{ asset('assets/img/GreenTechnology.jpg') }}" alt="GreenTechnology">
                </div>
            ...
            <div class="wow fadeInRight row align-items-center page-section" data-wow-delay="0.3s">
                ...
                <div class="col-lg-5">
                    <img class="img-fluid mx-auto d-block custom-img" src="{{ asset('assets/img/Infra.jpg') }}" alt="Infra">
                </div>
            </div>
