                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $newpaper; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo e(asset($item->file)); ?>" target="_blank">
                                                        <?php if($item['type'] == 1): ?>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <a href="#"
                                                                onclick="deletefundpdf('<?php echo e($item->id); ?>')"><i
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/wqq189w694ht/public_html/resources/views/admin/fundpdf.blade.php ENDPATH**/ ?>