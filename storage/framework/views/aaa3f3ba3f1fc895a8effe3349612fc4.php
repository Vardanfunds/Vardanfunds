<!-- Footer Start -->
     <footer class="footer">
        <div class="footer-links">
            ...
            <a href="<?php echo e(url('/policy')); ?>">Privacy Policy</a> |
            <a href="<?php echo e(url('/disclaimer')); ?>">Disclaimer</a> |
            <a href="<?php echo e(url('/termuse')); ?>">Terms of Use</a>
        </div>
...
<?php /**PATH D:\Web Devlopment\Vardanfunds\resources\views/partials/footer.blade.php ENDPATH**/ ?>